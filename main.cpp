...
//     std::array<unsigned int,2> screen_size{600,600}; // Размеры экрана в пикселях: первая координата - высота, вторая - ширина
    
//     Kinescope kins(point_of_view, screen_size[0], screen_size[1], screen_distance, angle_of_view, limit_of_visibility, direction_of_view, rotation, light_point);
...
//     std::vector<std::shared_ptr<Figure>> figuress;

//    cube1->set_colour(0, 250, 154);

//     figuress.push_back(sp1);
//     figuress.push_back(cube1);
